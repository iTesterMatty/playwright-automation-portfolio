...
def test_login_and_shop(page: Page, login_page: LoginPage, inventory_page: InventoryPage):
    # --- ACT ---
...
def test_sort_product_by_price(login_page: LoginPage, inventory_page: InventoryPage):
    # --- ACT ---
    # Login with correct credentials
    login_page.navigate()
    login_page.login("standard_user", "secret_sauce")
...
def test_login_invalid_password(page: Page, login_page: LoginPage):
...
def test_login_missing_username(page: Page, login_page: LoginPage):
    # --- ACT ---
